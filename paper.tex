...
\begin{figure}
	\includegraphics[width=\columnwidth]{plots/AvrgLatencyComp.pdf}
	\caption{Comparison of average latency under worst-case phasing, synchronous release, optimal phasing and random phasing. Normalized to the hyperperiod of the chain.}
