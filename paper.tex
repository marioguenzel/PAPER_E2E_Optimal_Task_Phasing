...
\label{sec:harmonic}
	...
	We achieve that, by ensuring that there is no slack between read- and write-events of $\pc^p_{W_p}$.
	...
	\begin{theorem}
		The task phasing presented in Equation~\eqref{eq:phasing} is optimal in minimizing the end-to-end latency for max-harmonic systems.
	\end{theorem}
